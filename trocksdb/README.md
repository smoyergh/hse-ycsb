...
This section describes how to run YCSB on TRocksDB running locally (within the same JVM).
...
Now you are ready to run! First, load the data:
    ...
    ./bin/ycsb load trocksdb -s -P workloads/workloada -p rocksdb.dir=/tmp/ycsb-rocksdb-data

Then, run the workload:

    ./bin/ycsb run trocksdb -s -P workloads/workloada -p rocksdb.dir=/tmp/ycsb-rocksdb-data
